...
const AddSparepart = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess('Sparepart added successfully!');
        setTimeout(() => navigate('/UserDashboard'), 1500);
      } else {
        throw new Error(data.error || 'Failed to add sparepart');
      }
    } catch (err) {
        ...
        <Container style={{ maxWidth: '650px' }}>
          <Card className="border-0 shadow-lg rounded-4" style={{ backgroundColor: '#1c1c1e', color: '#ffffff' }}>
            <Card.Body className="p-4">
              ...
              >
                <i className="bi bi-tools" style={{ fontSize: '3rem', color: '#ff4d4d' }}></i>
                <h2 className="mt-2 fw-bold">Add Sparepart</h2>
              </motion.div>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <motion.div whileHover={{ scale: 1.03 }}>
                  ...
                  >
                    {loading ? 'Uploading...' : 'Add Sparepart'}
                  </Button>
                </motion.div>
              </Form>
            </Card.Body>
...
//                 transition={{ delay: 0.2 }}
//               >
//                 <i className="bi bi-gear-fill" style={{ fontSize: '3rem', color: '#007BFF' }}></i>
//                 <h3 className="mt-2 fw-bold">Add Sparepart</h3>
//               </motion.div>
...
//                     <Form.Group>
//                       <Form.Label>Quantity*</Form.Label>
//                       <Form.Control type="number" min="1" name="quantity" value={formData.quantity} onChange={handleChange} required />
//                     </Form.Group>
//                   </Col>
//                 </Row>
...
//                   <Col>
//                     <Form.Group>
//                       <Form.Label>Quantity*</Form.Label> {/* ✅ NEW FIELD */}
//                       <Form.Control type="number" min="1" name="quantity" value={formData.quantity} onChange={handleChange} required />
//                     </Form.Group>
//                   </Col>
//                 </Row>
